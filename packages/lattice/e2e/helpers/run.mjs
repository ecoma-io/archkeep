// Executes the real `lattice` executable from an installed consumer workspace.
//
// E2E tests never import `../../src/` or any package export. They invoke the
// public bin shim written by pnpm (`pnpm exec lattice`) and assert only on
...
/**
 * Runs the installed public `lattice` CLI.
 *
 ...
 * @returns {CliResult}
 */
export function lattice(consumerRoot, args, options = {}) {
  const result = spawnSync("pnpm", ["exec", "lattice", ...args], {
    cwd: consumerRoot,
    encoding: "utf8",
