 ...
 * @param {{workspace: object, graph: object, skippedProjects?: object[], fileFailures?: object[], nativeMarker?: boolean, nativeModelFailure?: string|null, workspaceLayoutFailure?: string|null}} request.index
