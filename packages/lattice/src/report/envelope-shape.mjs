...
function typeName(value) {
  ...
  throw new Error(
    `lattice: refusing to build an envelope roster over a ${type} — an envelope holds only ` +
...
export function envelopeFieldPaths(envelope) {
  if (envelope === null || typeof envelope !== "object" || Array.isArray(envelope)) {
    throw new Error(
      `lattice: refusing to build an envelope roster over ${envelope === null ? "null" : `a ${Array.isArray(envelope) ? "array" : typeof envelope}`} ` +
