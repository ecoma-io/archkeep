...
//
//   LATTICE_UPDATE_ENVELOPE_SHAPE=1 npx vitest run src/report/envelope-shape.integration.test.mjs
//
...
async function envelopeFor(argv) {
  ...
  try {
    ...
    throw new Error(
      `lattice: '${argv.join(" ")}' wrote no JSON envelope (exit ${result.exitCode}). ` +
