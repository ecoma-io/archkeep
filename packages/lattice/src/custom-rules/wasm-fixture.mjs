 ...
 *
 * `lattice_describe` and `lattice_evaluate` return a constant packed range
 ...
 * second implementation of the contract in the way of that. `lattice_alloc`
 ...
 * @property {number} [growPagesOnEvaluate] Pages `lattice_evaluate` grows its
...
export function buildRuleModule(options = {}) {
  ...
  declare("lattice_alloc", 0x00, definedAt + 0);
  declare("lattice_describe", 0x00, definedAt + 1);
  declare("lattice_evaluate", 0x00, definedAt + 2);
...
/**
 * The body of `lattice_evaluate` for one behaviour.
 *
