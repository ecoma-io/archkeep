...
Write a Archkeep custom architecture rule in Rust, compile it to core
...
The crate is `archkeep-rule-sdk`; the directory carries the `-rust` suffix
because this tree holds four of these and a registry that already names the
