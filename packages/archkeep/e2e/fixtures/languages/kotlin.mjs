// Kotlin language fixture: three Maven projects with Kotlin imports.
// Proves Kotlin import discovery, package index resolution, and
...
// No Kotlin compilation required — Archkeep statically parses `.kt` files
// and `pom.xml` manifests.
//
// Uses single-line imports only — multi-line imports are a documented
// analyzer limit.
 ...
 */
export function kotlinLanguageFiles(packageName, peers, packageManager) {
  return {
    "package.json": `${JSON.stringify(
      {
        name: "consumer-lang-kotlin",
        private: true,
        type: "module",
        packageManager,
        devDependencies: {
    ...
    "libs/domain/src/main/kotlin/com/example/domain/Name.kt":
