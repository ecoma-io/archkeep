...
`history`, `trajectory`, `drift`, `impact`, `explain`, `context` and the rest of the
nineteen-command surface are in the [CLI reference](https://github.com/ecoma-io/archkeep/blob/main/docs/reference/cli.md).
