...
// `discoverProjects`/`buildNodes` live with the provider now
// (`../providers/nx-static.test.mjs`); this file tests the INDEX — the
// composition the seam contract assigns `buildWorkspaceIndex`. `buildNodes`
// is still imported, as a fixture builder for the edge tests below.
import { buildNodes } from "../providers/nx-static.mjs";
import { buildWorkspaceIndex, indexGaps } from "./workspace-index.mjs";
