...
//
//   ARCHKEEP_UPDATE_EVIDENCE_GOLDEN=1 npx vitest run src/custom-rules/evidence-golden.integration.test.mjs
//
...
const UPDATING = process.env.ARCHKEEP_UPDATE_EVIDENCE_GOLDEN === "1";
