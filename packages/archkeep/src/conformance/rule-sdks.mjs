 ...
 * `../../../archkeep-rule-sdk-go/examples/forbidden_tag_dependency/golden_test.go`
...
export const RULE_SDKS = Object.freeze([
  ...
  Object.freeze({
    name: "rust",
    origin: true,
    artifact: "../../../archkeep-rule-sdk-rust/examples/forbidden_tag_dependency.wasm",
    fixtures: "../../../archkeep-rule-sdk-rust/fixtures",
  }),
  Object.freeze({
    name: "go",
    origin: false,
    artifact: "../../../archkeep-rule-sdk-go/examples/forbidden_tag_dependency.wasm",
    fixtures: "../../../archkeep-rule-sdk-go/fixtures",
  }),
  Object.freeze({
    name: "typescript",
    origin: false,
    artifact: "../../../archkeep-rule-sdk-ts/examples/forbidden-tag-dependency.wasm",
    fixtures: "../../../archkeep-rule-sdk-ts/fixtures",
  }),
  Object.freeze({
    name: "python",
    origin: false,
    artifact: "../../../archkeep-rule-sdk-python/examples/forbidden_tag_dependency.wasm",
    fixtures: "../../../archkeep-rule-sdk-python/fixtures",
  }),
]);
