 ...
 * and `./options.mjs` is reached from `./graph/create-dependencies.mjs`,
 * which `../nx.mjs` re-exports — the entry Nx loads on EVERY graph
 * computation. A shared module is also the only way the two can
