...
// (`../../lattice-rule-sdk-rust/examples/forbidden_tag_dependency.rs`), reason
...
// `lattice_alloc` is the ABI's one export a rule never writes itself. A wasm
...
export { lattice_alloc } from "../assembly/index";
...
/** What this artifact IS: the document `lattice_describe` answers with. */
