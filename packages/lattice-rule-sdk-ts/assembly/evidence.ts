...
// assembly (`../../lattice/src/custom-rules/evidence.mjs`) and the frozen record
// it copies through (`../../lattice/src/analysis/contract.md`). The bundle is
// the wire, not the engine's internals: `../../lattice/src/config.mjs` calls the
...
// `../../lattice/src/analysis/contract.md` fixes those four kinds, and a fifth
