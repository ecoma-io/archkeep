...
// `lattice_evaluate trapped (unreachable)`.
//
...
// (`../../lattice-rule-sdk-rust/src/abi.rs`), and a conformance suite that
...
// (`../../lattice/src/canonical.mjs`) plus whatever a policy row's `params`
