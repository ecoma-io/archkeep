...
// (`../../lattice/src/custom-rules/host.mjs`) and is deliberately not
...
//   constraint schema has exactly one owner (`../../lattice/src/config.mjs`) and
...
export { lattice_alloc, pack, describePacked, evaluatePacked } from "./abi";
