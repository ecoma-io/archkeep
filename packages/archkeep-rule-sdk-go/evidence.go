...
// assembly (../archkeep/src/custom-rules/evidence.mjs) and the frozen record it
// copies through (../archkeep/src/analysis/contract.md). The bundle is the wire,
// not the engine's internals: ../archkeep/src/config.mjs calls the eight
...
// writes an UnmarshalJSON by hand. ../archkeep/src/analysis/contract.md fixes
...
// (../archkeep/src/analysis/contract.md). Rust spells the same guarantee as an
// Option of two NonZeroU32 and gets it from the type system
// (../archkeep-rule-sdk-rust/src/evidence.rs); Go has no non-zero integer, so
...
// constraint row schema has exactly one owner (../archkeep/src/config.mjs, which
