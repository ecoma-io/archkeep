...
// (../../archkeep/src/custom-rules/host.mjs), so code that could never run
...
// (../../archkeep-rule-sdk-rust/src/harness.rs).
//
...
// document.
//
// evaluate is [github.com/ecoma-io/archkeep/packages/archkeep-rule-sdk-go.EvaluateJSON]
// — the same function the artifact's archkeep_evaluate export calls, so what a
