...
//! assembly (`../../lattice/src/custom-rules/evidence.mjs`) and the frozen
//! record it copies through (`../../lattice/src/analysis/contract.md`). The
//! bundle is the wire, not the engine's internals: `../../lattice/src/config.mjs`
...
//! because `../../lattice/src/analysis/contract.md` fixes those four kinds, and
...
impl ImportRecord {
    ...
    /// (`../../lattice/src/analysis/contract.md`). Returning an `Option`
...
/// (`../../lattice/src/config.mjs`, which validates it at load), and a second
