 ...
 * (`../../archkeep/src/custom-rules/evidence.mjs`) and then formatted for review,
 * and they are byte-identical to the Rust SDK's copies
 * (`../../archkeep-rule-sdk-rust/fixtures/`) — the same five documents, so a
 ...
 * `../../archkeep/src/conformance/rule-sdks.integration.test.mjs` reads every
 ...
 *
 * The Rust suite calls the pure `archkeep_evaluate_json` directly, because a
...
import { evaluateCustomRule, loadCustomRule } from "../../archkeep/src/custom-rules/host.mjs";
 ...
 * `archkeep_describe` in a worker, and a shared promise would make one test's
