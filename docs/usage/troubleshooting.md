...
| symptom                                  | cause                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| no workspace found                       | not run from inside a git repository carrying a workspace marker (`nx.json`, `archkeep.json`, or a `.moon/workspace.yml` / `.config/moon/workspace.yml`). The walk stops at the enclosing repository's top level, so a marker above it — a user-level `~/.moon` state directory — never counts                                                                                              |
