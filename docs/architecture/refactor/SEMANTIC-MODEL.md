...
| Architecture intent (the law)              | `src/architecture-intent/model.mjs` + `judge.mjs` + `intent-fingerprint.mjs`                                                                                    | drift, check (via driftForCheck), reconcile, delta, change, fitness, discover, decisions, health, report             | clean                                                                                              |
