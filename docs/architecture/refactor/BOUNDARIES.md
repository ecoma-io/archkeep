...
| `nodeTypeOf`'s `lib` default (`native/discover.mjs:64-69`)                                    | (b)                           | shared primitive, its `lib` fallback the pinned default; the LSP row consumes it, never re-derives                                                                                         |
