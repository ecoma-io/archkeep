...
| 1    | findings -- boundary violations, declared-edge violations, go.work drift, dead tsconfig path aliases, intent findings, or a failing fitness gate | `check` and `fitness`. A failing fitness function is a finding (D-09); every other command that finds something reports it but exits 0.                                                                                                                                                                                                                                                                                                                             |
