...
| `graph`, `diff`, `drift`, `discover`, `reconcile`, `waivers`, `fitness`, `history`, `trajectory`, `health`, `report`, `debt`, `impact`, `explain`, `context`, `provenance`, `adr` | `text`, `json`          | `text`  | Terminal report or the versioned JSON envelope. No SARIF -- descriptive commands produce no findings. |
