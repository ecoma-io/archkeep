...
| `command`       | string                                   | Which command produced this envelope. `"check"`, `"graph"`, `"diff"`, `"delta"`, `"change"`, `"discover"`, `"drift"`, `"reconcile"`, `"waivers"`, `"fitness"`, `"history"`, `"trajectory"`, `"health"`, `"report"`, `"debt"`, `"impact"`, `"explain"`, `"context"`, `"provenance"`, or `"adr"`.                                                                                                                                                                |
