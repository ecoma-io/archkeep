...
| `affected`        | object                                                                     | The identity strings the same mapping derives: `{projects, boundaries, constraints, decisions}`, each sorted and de-duplicated. `projects` are the changed project names, `boundaries` the changed edge identities (`source>target:type`), `constraints` the canonical `depConstraints` rows the introduced/resolved violations name, and `decisions` the moved ADR ids — always `[]` for `delta`, which compares no decision registry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
