...
| `"findings"`   | `1`        | Boundary violations, go.work drift, dead tsconfig path aliases, or architecture-intent findings — one or more of `result.violations`, `result.goWork.findings`, `result.tsconfigPaths.findings`, `result.intent.findings` is non-empty.                            |
