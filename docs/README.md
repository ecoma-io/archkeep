...
| [`docs/architecture/refactor/`](architecture/refactor/README.md)                      | The refactor program's control plane: constitution, invariant registry, authority map, migration plan — bound by doctrine, never beside it                                                                                                                  |
