...
| `docs/concepts/`                                                                | The model: architecture, graph, boundaries, policies, projects, drift, evidence, waivers, health, fitness functions, reconciliation, agentic development, integrations |
