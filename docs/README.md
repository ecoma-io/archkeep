...
| [0009-moon-derived-tags-provider-policy.md](adr/0009-moon-derived-tags-provider-policy.md)           | The Moon provider derives `layer:`/`stack:` tags from Moon's own classification — recorded provider policy              |
| [0010-moon-workspace-layout-inference.md](adr/0010-moon-workspace-layout-inference.md)               | The Moon provider infers `workspaceLayout` from project roots, complete or withheld — recorded provider policy          |
| [0011-agent-workflow-protocol.md](adr/0011-agent-workflow-protocol.md)                               | The agent workflow protocol is adopted: the five skills carry the forcing points, gated by `check-skills` and the suite |

## Doctrine

| page                                                                  | what it answers                                                                                                                                |
| --------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [impact-analysis.md](doctrine/impact-analysis.md)                     | The first intelligence capability: what a change touches, the evidence for each claim, and why impact is never risk                            |
| [scenario-evaluation.md](doctrine/scenario-evaluation.md)             | The second intelligence capability: evaluating a hypothetical change against a base revision, read-only, never a Decision                      |
| [evidence-grounded-advisor.md](doctrine/evidence-grounded-advisor.md) | The third intelligence capability: a reasoning layer that reads canonical facts, marks FACT from INFERENCE, and never decides                  |
...
| [agent-workflow.md](doctrine/agent-workflow.md)                       | The agent-facing layer: the measured failures, the failure taxonomy, and the per-skill verdicts as landed — the measurement record             |
| [agent-workflow-protocol.md](doctrine/agent-workflow-protocol.md)     | The adopted workflow protocol: the decisions, the state machine, the evidence wiring, and the evaluation suite that would falsify it           |
| [roadmap.md](doctrine/roadmap.md)                                     | The strategy in three tiers, the maturity model (five phases of trust), the conditions stable 1.0 waits on, and the later maturity beyond them |
...
| [`docs/doctrine/roadmap.md`](doctrine/roadmap.md)                                     | The strategy in three tiers, the maturity model (five phases of trust), the conditions stable 1.0 waits on, and the later maturity beyond them, in that order                                                                                               |
| [`docs/doctrine/1-0-semantic-contract.md`](doctrine/1-0-semantic-contract.md)         | The 1.0 freeze manifest: which surfaces become compatibility commitments, where each is bound, how future changes are classified, and the open 1.0 decisions                                                                                                |
...
| [`docs/doctrine/agent-workflow.md`](doctrine/agent-workflow.md)                       | The agent workflow: what was measured to fail, the A–G failure taxonomy, and the redesign constraints — the ownership page for agent-facing failure modes                                                                                                   |
| [`docs/doctrine/agent-workflow-protocol.md`](doctrine/agent-workflow-protocol.md)     | The adopted workflow protocol: the D1–D5 decisions, the state machine, the per-skill ownership, and the evidence wiring — the ownership page for how agent workflow steps must consume engine signals                                                       |
