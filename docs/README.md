...
| [agent-workflow.md](doctrine/agent-workflow.md)                       | The agent-facing layer: the measured failures, the failure taxonomy, the per-skill verdicts, and what a workflow redesign is judged on               |
| [agent-workflow-protocol.md](doctrine/agent-workflow-protocol.md)     | The workflow protocol (draft, pending review): the decisions, the state machine, the evidence wiring, and the evaluation suite that would falsify it |
...
| [`docs/doctrine/agent-workflow-protocol.md`](doctrine/agent-workflow-protocol.md)     | The workflow protocol (draft): the D1–D5 decisions, the state machine, the per-skill change spec, and the evidence wiring — the ownership page for how agent workflow steps must consume engine signals                                                     |
