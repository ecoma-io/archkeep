...
| `docs/concepts/`                                                                | The model: architecture, graph, boundaries, policies, projects, drift, discovery, evidence, waivers, health, fitness functions, reconciliation, agentic development, integrations |
