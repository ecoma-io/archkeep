...
- **Eighteen commands — `check`, `graph`, `diff`, `delta`, `discover`,
  `drift`, `reconcile`, `waivers`, `fitness`, `history`, `health`, `report`,
  `debt`, `impact`, `explain`, `context`, `provenance`, `adr`** — each with
