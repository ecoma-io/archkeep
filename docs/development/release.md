...
| a quiet stretch in what an unchanged workspace is told | **not met** | `pnpm readiness` reads "3 of 50 commits" since #832 (2026-09-09); #832 touched `docs/reference/exit-codes.md` and `docs/reference/json-output.md` and #827 touched `src/report/text.mjs` without markers, and #834's own landing ticked the count from 2. The stretch counts quiet commits, so it moves only by landing without verdict-surface changes                                                                                                                                                               |
...
verdict-quiet commits to land on `main` — roughly 47 more at the 2026-09-09
